...
db.prepare('INSERT INTO job (recruiter_id, title, status, about_role, requirements, responsibilities, location, salary, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)').run(1, 'Software Engineer', 'open', 'Build scalable backend services using Node.js and Python.', '3+ years Node.js, experience with REST APIs, knowledge of SQL databases', 'Design and implement backend APIs, optimize database queries, collaborate with frontend team on integrations', 'Lahore', 150000, 'full-time');
db.prepare('INSERT INTO job (recruiter_id, title, status, about_role, requirements, responsibilities, location, salary, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)').run(1, 'Frontend Developer', 'open', 'Create beautiful React UIs with Tailwind CSS.', '2+ years React, TypeScript, CSS/Tailwind, responsive design', 'Build reusable UI components, ensure cross-browser compatibility, optimize page performance', 'Remote', 120000, 'remote');
db.prepare('INSERT INTO job (recruiter_id, title, status, about_role, requirements, responsibilities, location, salary, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)').run(2, 'Data Scientist', 'open', 'Analyze large datasets and build ML models.', 'Python, TensorFlow/PyTorch, SQL, statistics background', 'Develop predictive models, clean and preprocess data, present insights to stakeholders', 'Karachi', 180000, 'full-time');
db.prepare('INSERT INTO job (recruiter_id, title, status, about_role, requirements, responsibilities, location, salary, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)').run(2, 'DevOps Engineer', 'open', 'Manage cloud infrastructure on Azure.', 'Azure/AWS experience, Docker, CI/CD pipelines, Linux administration', 'Set up and maintain cloud infrastructure, automate deployments, monitor system health', 'Islamabad', 160000, 'contract');
db.prepare('INSERT INTO job (recruiter_id, title, status, about_role, requirements, responsibilities, location, salary, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)').run(1, 'Intern - Web Development', 'closed', 'Learn web development with experienced mentors.', 'Basic HTML/CSS/JS knowledge, eagerness to learn, currently enrolled in CS or related program', 'Assist with frontend tasks, write documentation, shadow senior developers on projects', 'Lahore', 30000, 'part-time');
